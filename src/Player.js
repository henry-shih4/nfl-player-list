          ...
          <div>
            <div className="flex flex-col justify-center items-center min-h-screen">
              ...
              <div className="flex justify-center items-center flex-wrap w-3/4">
                <div className="flex justify-center items-center">
                  <div>
                    {playerBio ? (
                      <>
                        <div className="text-sm rounded-xl w-[500px] min-h-[400px] flex flex-col justify-center items-center p-3 bg-slate-100 border border-solid border-indigo-500">
                          <div>
                            <div className="flex justify-center items-center">
                              <img
                                alt={`${playerInfo.name}`}
                                className="w-[300px] h-[400px] rounded-full object-cover"
                                src={playerImage}
                              />
                            </div>
              ...
              <div
                className={
                  editPlayer
                    ? "absolute bg-indigo-300 justify-center items-center flex-col w-[300px] min-h-[400px] border border-solid border-indigo-500 rounded-lg"
                    : "hidden"
                }
              >
                {playerInfo ? (
